    ...
    <div>
        ...
        <div class="content font-class" style="display: block;">
            <ul class="icon_lists dib-box">
                ...
                <li class="dib">
                    <span class="icon iconfont icon-gifts"></span>
                    <div class="name">
                        gifts
                    </div>
                    <div class="code-name">.icon-gifts
                    </div>
                </li>
                ...
                <li class="dib">
                    <span class="icon iconfont icon-imagetext"></span>
                    <div class="name">
                        image-text
                    </div>
                    <div class="code-name">.icon-imagetext
                    </div>
                </li>
                ...
                <li class="dib">
                    <span class="icon iconfont icon-remind1"></span>
                    <div class="name">
                        remind
                    </div>
                    <div class="code-name">.icon-remind1
                    </div>
                </li>

                <li class="dib">
                    <span class="icon iconfont icon-icondownload"></span>
                    <div class="name">
                        download
                    </div>
                    <div class="code-name">.icon-icondownload
                    </div>
                </li>
                ...
                <li class="dib">
                    <span class="icon iconfont icon-iconfontplay2"></span>
                    <div class="name">
                        play
                    </div>
                    <div class="code-name">.icon-iconfontplay2
                    </div>
                </li>

                <li class="dib">
                    <span class="icon iconfont icon-iconfontstop"></span>
                    <div class="name">
                        stop
                    </div>
                    <div class="code-name">.icon-iconfontstop
                    </div>
                </li>
                ...
                <li class="dib">
                    <span class="icon iconfont icon-exl"></span>
                    <div class="name">
                        exl
                    </div>
                    <div class="code-name">.icon-exl
                    </div>
                </li>
                ...
                <li class="dib">
                    <span class="icon iconfont icon-survey1"></span>
                    <div class="name">
                        survey
                    </div>
                    <div class="code-name">.icon-survey1
                    </div>
                </li>
                ...
                <li class="dib">
                    ...
                    <div class="code-name">.icon-trade
                    </div>
                </li>
